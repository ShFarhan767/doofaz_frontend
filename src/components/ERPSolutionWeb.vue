        ...
        <div class="container mx-auto">
            <div v-if="websiteType && websiteType.data"
                ...
                <RouterLink :to="`/website-details/${item.id}`"
                    v-for="(item, index) in websiteType.data.filter(item => item.frontendShowStatus === 'enable')"
                    :key="index">
                    <div class="border-[2px] h-auto rounded-[10px] cursor-pointer hover:bg-[#f1f1f1] shadow-lg lg:pb-10 pb-5 text-center hover-card">
